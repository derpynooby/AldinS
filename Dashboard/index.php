                    ...
                    <ul class="side-menu ">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <?php foreach ($dashboardlink as $row) :  ?>
            ...
            <div class='main-container container-fluid '>
                ...
                <div class='breadcrumb-header d-block '>
                    <div class='d-flex col-12'>
                        <img class='wd-200 m-0 bd bd-3 bd-danger rounded-30' alt='logo' src='img/owner.jpg' alt=''>
                ...
                <!-- row -->
                <div class='row'>
                    <div class='col-12 col-4 bg-transparent text-dark'>
                        <div class='d-flex'>
                            <div class='col-12 card overflow-hidden p-2'>
                                <div class='card-header bg-transparent pd-b-0 pd-t-20 bd-b-0'>
                                    <div class='d-flex justify-content-between'>
                                        <h4 class='card-title mg-b-10'><?php echo $filename ?></h4>
                                        <i class='mdi mdi-dots-horizontal text-gray'></i>
                                    </div>
                                    <p class='tx-1'>The Project Budget is a tool used by project managers to estimate the total cost of a project. <a href=''>Learn more</a></p>
                                    <img class='' src='code/$imagename' alt=''>
                                </div>
