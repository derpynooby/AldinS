			...
			<div class="main-signin-wrapper">
				...
				<div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
					<div class="my-auto authentication-pages">
						<div>
							...
							<h5 class="mb-4">Digital library Officer</h5>
				...
				<div class="sign-up-body wd-md-50p">
					<div class="main-signin-header">
						...
						<h4>Please sign in with your Digital Library Officer's ID</h4>
						<form action="profile.php" method="post">
							<div class="form-group">
								<label>Username</label> <input name="name" class="form-control" placeholder="Enter your username" type="text" required>
							</div>
							<div class="form-group">
								<label>Email</label> <input name="email" class="form-control" placeholder="Enter your email" type="text" required>
							</div>
							<div class="form-group">
								<label>Password</label> <input name="password" class="form-control" placeholder="Enter your password" type="password" required>
							</div>
							<div class="form-group">
								<label>Officer ID</label> <input name="id" class="form-control" placeholder="Enter your ID" type="password" required>
							</div><button type="submit" name=submit class="btn btn-primary btn-block">Sign In</button>
						</form>
					</div>
					</div>
				</div>
