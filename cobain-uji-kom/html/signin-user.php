			...
			<div class="main-signin-wrapper">
				...
				<div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
					<div class="my-auto authentication-pages">
						<div>
							...
							<h5 class="mb-4">Welcome back to Digital Library</h5>
							...
							<a href="index.html" class="btn btn-outline-light text-light">Learn More</a>
						</div>
					</div>
				</div>
				<div class="sign-up-body wd-md-50p">
					<div class="main-signin-header">
						<h2>Welcome back!</h2>
						<h4>Please sign in with your Digital Library account</h4>
						<form action="" method="post">
							<div class="form-group">
								<label>Username</label> <input name="username" class="form-control" placeholder="Enter your username" type="text" required>
							</div>
							<div class="form-group">
					...
					<div class="main-signup-footer mg-t-10">
						<p>Doesn't have an account? <a href="register.html">Create account</a></p>
					</div>
					</div>
				</div>
			</div>
